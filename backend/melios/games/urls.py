...
from .api import GamesAPI,GetGameById,GetPicturesByGameId, GetGameByCatergory, GetCategory, GetCategoryById
...
urlpatterns = [
    ...
    path('category/categoryid/<int:id>/',GetCategoryById.as_view())
]
